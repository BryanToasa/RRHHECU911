        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="form-horizontal form-material">
                        <div class="form-group">
                            <div class="col-md-12 m-b-20">
                                ...
                                <asp:TextBox ID="Txt_Nombrecargo" runat="server" type="text" class="form-control" placeholder="Nombre "></asp:TextBox>
                            </div>
                            <div class="col-md-12 m-b-20">
                                <!--AQUI EDITAS EL CUADRO DE Nombre NUEVO CARGO-->
                                <asp:TextBox ID="Txt_Estadocargo" runat="server" type="text" class="form-control" placeholder="Cargo"></asp:TextBox>
                ...
                <div class="modal-footer">
                     <asp:Button ID="Btn_Guardar" runat="server" Text="Guardar" OnClick="Btn_Guardar_Click1"/>
                    <asp:Button ID="Btn_Cancelar" runat="server" Text="Cancelar" class="btn btn-default waves-effect" data-dismiss="modal" />

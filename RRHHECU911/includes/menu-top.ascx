<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="menu-top.ascx.cs" Inherits="RRHHECU911.includes.menu_top1" %>
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src='<%= Page.ResolveUrl("~/assets/images/logo-icon.png") %>' alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src='<%= Page.ResolveUrl("~/assets/images/logo-light-icon.png") %>' alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src='<%= Page.ResolveUrl("~/assets/images/logo-text.png") %>' alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
                         <img src='<%= Page.ResolveUrl("~/assets/images/logo-light-text.png") %>' class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src='<%= Page.ResolveUrl("~/assets/images/users/1.jpg") %>' alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>

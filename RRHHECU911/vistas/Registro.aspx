<%@ Page Title="" Language="C#" MasterPageFile="~/SistemaEcu911.Master" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="RRHHECU911.vistas.Registro" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenedorMaestro" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
